    ...
    return (
        <Stack sx={{ px: 20, gap: 2, justifyContent: "center" }}>
            ...
            <Typography variant="body1">
                ...
                of the project was built using React, Vite, and Material UI. The backend of
                the project was built using Convex. The project is dockerized and was deployed using Fly.io.
            </Typography>
